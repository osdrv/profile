...
You can define profiles via hash, this way input hash keys 
would be a result keys, and input key values would be an 
instance methods to call when profile builds.
